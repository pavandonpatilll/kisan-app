...
def agri_news(user_id: str):
    ...
    try:
        ...
        try:
            ...
            # Maximum 20 admin news
            admin_rows = admin_rows[:20]
        ...
        try:
            ...
            print(
                "NEWS API failed, using admin news only:",
                e
            )
...
def create_subscription(data: dict):
    ...
    try:
        ...
        # BASIC:
        # TODAY = ₹5
        # NEXT MONTH = ₹150/month
        #
        # ADVANCED:
        # TODAY = ₹17
        # NEXT MONTH = ₹200/month
        # ==========================

        if plan_key == "basic_monthly":

            # IMPORTANT:
            # This is the ₹150/month recurring plan.
            # DO NOT replace this with the ₹5 Razorpay plan.
        ...
        subscription = (
            ...
            .create({
                ...
                # IMPORTANT:
                # basic_recurring = ₹150/month
                # advanced_recurring = ₹200/month
