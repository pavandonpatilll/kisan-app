...
# ==========================
# FIX EXISTING PREMIUM PAYMENT
# TEMPORARY ADMIN ENDPOINT
# ==========================

@app.get("/admin/fix-premium-payment")
def fix_premium_payment():

    try:

        user_id = 13

        payment_id = "pay_TVGBc5ckgKv7Yt"

        subscription_id = "sub_TVGBJtPa2p3T7w"
        ...
        return {
            ...
            "message": "Existing payment data fixed",
